...
class EltGeneratorInitCircle(EltGenerator):
    ...
    def __init__(self, radius, input_radius_factor=.1, imshow_kwargs={"fill": True}):
        super().__init__()
        self.radius = radius
