...
all_args['batch_seed'] = [3824282968]  # put to None for random seed

all_args['n_try'] = [0]
# all_args['n_try'] = range(1, 11)  # uncomment to launch 10 identical trials

all_args['experiment_name'] = [
    "inverted_mnist_erosion_hstick"
]


# DATA ARGS
all_args['morp_operation'] = [ParallelMorpOperations.erosion(('hstick', 7))]
