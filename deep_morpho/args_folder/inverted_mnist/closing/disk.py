...
all_args['batch_seed'] = [3050055195]  # put to None for random seed

all_args['n_try'] = [0]
# all_args['n_try'] = range(1, 11)  # uncomment to launch 10 identical trials

all_args['experiment_name'] = [
    "inverted_mnist_closing_disk"
]


# DATA ARGS
all_args['morp_operation'] = [ParallelMorpOperations.closing(('disk', 3))]
all_args['dataset_type'] = ['inverted_mnist']
...
all_args['loss_data_str'] = ["MaskedBCELoss"]
